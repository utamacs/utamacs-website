...
export const RULE = {
  ...
  LATE_FEE_GRACE_PERIOD_DAYS:       'LATE_FEE_GRACE_PERIOD_DAYS',
  LATE_FEE_DEFAULT_RATE_PCT:        'LATE_FEE_DEFAULT_RATE_PCT',
  LATE_FEE_MAX_CAP_AMOUNT:          'LATE_FEE_MAX_CAP_AMOUNT',
  LATE_FEE_CRON_ENABLED:            'LATE_FEE_CRON_ENABLED',
  GST_THRESHOLD_MONTHLY:            'GST_THRESHOLD_MONTHLY',
  GST_RATE_MAINTENANCE:             'GST_RATE_MAINTENANCE',
